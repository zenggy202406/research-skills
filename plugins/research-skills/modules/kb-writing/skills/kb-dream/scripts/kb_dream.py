...
Vitality model (cumulative):
    ...
    Each dream cycle applies a delta:
      ...
      +0.10 per new relationship (degree increase) since last dream
      -0.10 decay if no new activity
    Pruning cutoff: vitality < 0.3 (configurable via --threshold).
"""
